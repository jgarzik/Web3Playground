 ...
 * SVG Icon Components
 * 
 * Complete set of SVG replacements for Lucide React icons used in Jeff's Hacker Haven.
 * Each icon maintains the same visual appearance as its Lucide counterpart.
 */
...
export const DotIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
